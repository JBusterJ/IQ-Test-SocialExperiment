...
var questions = [
    ...
    '<p>Q4. The area of a square is 100 cm^2.If the length of each side is decreased by 20%, then the area of the new square in cm^2 is: 64</p><input type="text" placeholder = "Enter answer here..." id="answerBox"><br><p>Remember that you cannot return to questions once you have submitted them... please double check your answer before submitting!</p><br><button onclick="nextQuestion()">Next question</button>',
...
function finishTest() {
    ...
    alert(`Your answers to the questions were [${userAnswers}]\nDue to the reason of keeping answers to the test secret, we are unable to show you the correct answers for the test. With this being, you have an estimated iq of ${displayedIQ} with a margin of error of less than a quadrillionth.`);
    document.getElementById("descriptions").innerHTML = "";
    document.getElementById("test").innerHTML = "";
    dummy = document.createElement("span");
    document.getElementById("descriptions").appendChild(dummy);
    dummy.insertAdjacentHTML('afterend', `<h1 id='title' style="color: rgb(255, 211, 117)">Thank you for taking the test!</h1><h5>You are one of the <b id='usercountaccurate'>32 million</b> users who have accessed this IQ test. This IQ test initially served the purpose of being a practice IQ test, but over time, more and more individuals accessed this IQ test, contributing to calculations and questions. Without you, we wouldn't be where we are today!</h5><br><p>As stated previously, your has been measured to be ${displayedIQ}. Although this score may not seem like much, you are marginally close to the average score, with the average score for 12-16 year olds being a whopping 112 IQ points (${displayedIQ} points off).<br>Your IQ score is the bottom 50% of the world average.<br>Are you looking to strive for higher intelligence? Well, to inspire you, the highest IQ score recorded and measured by exact this IQ test (on our previous test domain, <a href='https://www.mensa.org/'>https://www.mensa.org/</a>) was a 177.231443543 - about 50 IQ points from the highest recorded IQ score in the world!</p><br>Although not accurate, this image can be a decent referencing tool for IQ classifying <br><br><img src='https://www.free-iqtest.net/images/iq-scale.png' style='width: 750px;'>`);
}
